...
<?php
	...
	$getAllRooms = []; // default empty array

	if (isset($_GET['id'])) {
		$id = $_GET['id'];

		$getRooms = $conn->prepare("SELECT * FROM rooms WHERE hotel_id = :id");
		$getRooms->bindParam(':id', $id, PDO::PARAM_INT);
		$getRooms->execute();
								...
								<div class="half left-arrow d-flex align-items-center">
									<div class="text p-4 p-xl-5 text-center">
										...
										<ul class="list-accomodation">
											<li><span>Max:</span><?php echo $room->num_persons;?> People</li>
