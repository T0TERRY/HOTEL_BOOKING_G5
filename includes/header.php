<?php
	 session_start();
	 define("APPURL","http://localhost:3000/hotel-booking/");
...
<html lang="en">
  <head>
    <title>Vacation Rental - Group 5</title>
    <meta charset="utf-8">
			...
			<div class="container">
				<div class="row justify-content-between">
						<div class="col d-flex align-items-center">
							<p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+855 93 338 472</a> or <span class="mailus">email us:</span> <a href="#">ypengly060@email.com</a></p>
						</div>
