          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p>Easy-to-follow map and directions provided for a smooth arrival.</p>
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p>Clean rooms, free Wi-Fi, and friendly 24/7 support.</p>
                <p><a href="#" class="btn btn-primary">Read more</a></p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p>Comfortable stay with helpful staff and welcoming vibes.</p>
                <p><a href="#" class="btn btn-primary">Read more</a></p>
              </div>
            </div>      
          </div>
